...
#Bessie, go over this with mentor 

def make_new_student(first_name, last_name, github):
    query = """INSERT into Students VALUES (?, ?, ?) """ #this is being pulled into SQL database, not your typical variable
...
# Bessie, go over this with your mentor on Weds
def text_args(args):
    new_args = []
    string = ''
    is_quote = False
...
add_project project_title project_description maximium_grade
give_grade github project_title grade

======== Get Commands ========
student github
get_project project_title
project_grade github project_title
show_grade github
